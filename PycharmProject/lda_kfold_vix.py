...
for i in range(0, window_length):
     df['USD_N-' + str(i)] = transformed[:, i]
     df['VIX_N-' + str(i)] = transformed[:, i+window_length]
...
prob_thresholds = np.linspace(0.5, 0.65, num=21)
#prob_thresholds = np.array([0.5825]) # 0.52 k = 5, 0.515 k = 10
